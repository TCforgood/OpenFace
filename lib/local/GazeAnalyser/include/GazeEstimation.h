...
namespace GazeAnalysis
{
	...
	void EstimateGaze(const LandmarkDetector::CLNF& clnf_model, cv::Point3f& gaze_absolute, cv::Point3f& eyeball, float fx, float fy, float cx, float cy, bool left_eye);
